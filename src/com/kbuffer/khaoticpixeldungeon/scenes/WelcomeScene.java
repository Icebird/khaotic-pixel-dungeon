...
public class WelcomeScene extends PixelScene {
	...
	private static final String LNK = "https://play.google.com/store/apps/details?id=com.kbuffer.shatteredpixeldungeon";

	@Override
	public void create() {
		super.create();

		final int gameversion = KhaoticPixelDungeon.version();
		...
		RedButton okay = new RedButton("Okay!") {
			...
			protected void onClick() {
				...
				KhaoticPixelDungeon.version(Game.versionCode);
