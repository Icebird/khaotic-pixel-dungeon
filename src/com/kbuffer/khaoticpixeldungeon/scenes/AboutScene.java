...
public class AboutScene extends PixelScene {
	...
	public void create() {
		...
		final float colWidth = Camera.main.width / (KhaoticPixelDungeon.landscape() ? 2 : 1);
		final float colTop = (Camera.main.height / 2) - (KhaoticPixelDungeon.landscape() ? 30 : 90);
		final float wataOffset = KhaoticPixelDungeon.landscape() ? colWidth : 0;
		...
		wata.y = align( KhaoticPixelDungeon.landscape() ?
						colTop:
