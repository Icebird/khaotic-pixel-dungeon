...
public class StartScene extends PixelScene {
	...
	public void create() {
		...
		float width, height;
		if (KhaoticPixelDungeon.landscape()) {
			width = WIDTH_L;
			height = HEIGHT_L;
		} else {
			width = WIDTH_P;
		...
		curClass = null;
		updateClass( HeroClass.values()[KhaoticPixelDungeon.lastClass()] );
		...
		Badges.loadingListener = new Callback() {
			...
			public void call() {
				if (Game.scene() == StartScene.this) {
					KhaoticPixelDungeon.switchNoFade(StartScene.class);
				}
			}
		};
	}
	...
	private void startNewGame() {
		...
		if (KhaoticPixelDungeon.intro()) {
			KhaoticPixelDungeon.intro(false);
	...
	protected void onBackPressed() {
		KhaoticPixelDungeon.switchNoFade(TitleScene.class);
	}
	...
	private class ChallengeButton extends Button {
		...
		protected void createChildren() {
			...
			image = Icons.get( KhaoticPixelDungeon.challenges() > 0 ? Icons.CHALLENGE_ON :Icons.CHALLENGE_OFF );
			add( image );
		}
		...
		protected void onClick() {
			if (Badges.isUnlocked( Badges.Badge.VICTORY )) {
				StartScene.this.add(new WndChallenges(KhaoticPixelDungeon.challenges(), true) {
					public void onBackPressed() {
						super.onBackPressed();
						image.copy( Icons.get( KhaoticPixelDungeon.challenges() > 0 ?
