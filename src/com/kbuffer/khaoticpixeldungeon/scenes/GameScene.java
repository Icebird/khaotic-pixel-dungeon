...
import com.kbuffer.khaoticpixeldungeon.sprites.TrapSprite;
...
public class GameScene extends PixelScene {
	...
	public void create() {
		...
		KhaoticPixelDungeon.lastClass(Dungeon.hero.heroClass.ordinal());
		
		super.create();
		Camera.main.zoom( GameMath.gate(minZoom, defaultZoom + KhaoticPixelDungeon.zoom(), maxZoom));
		...
		brightness( KhaoticPixelDungeon.brightness() );
