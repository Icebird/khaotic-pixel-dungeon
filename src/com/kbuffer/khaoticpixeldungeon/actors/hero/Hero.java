...
import com.kbuffer.khaoticpixeldungeon.actors.buffs.Bless;
...
import com.kbuffer.khaoticpixeldungeon.items.artifacts.EtherealChains;
				...
				if (item.doPickUp( this )) {
					...
					if (item instanceof Dewdrop
						...
						if (belongings.weapon == null &&
							...
							((Weapon) item).doEquip( this, false );
						}
						// end KPD
